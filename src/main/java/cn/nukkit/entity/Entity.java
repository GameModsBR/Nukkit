...
public abstract class Entity extends Location implements Metadatable {
    ...
    public static final int DATA_HAS_COMMAND_BLOCK = 69; //byte
    ...
    public static final int DATA_EVOKER_SPELL_COLOR = 76; // int -- Backward compatibility
    public static final int DATA_SPELL_CASTING_COLOR = 76; //int -- NukkitX compatibility
    ...
    public static final int DATA_BOAT_BUBBLE_TIME = 86; // Backward Compatibility
    public static final int DATA_BUBBLE_TIME = 86; // NukkitX
    public static final int DATA_AGENT_ID = 87; // Backward Compatibility
    ...
    public static final int DATA_AREA_EFFECT_CLOUD_DURATION = 94; // int - Backward Compatibility
    public static final int DATA_DURATION = 94; // NukkitX
    public static final int DATA_AREA_EFFECT_CLOUD_SPAWN_TIME = 95; // long - Backward Compatibility
    public static final int DATA_SPAWN_TIME = 95; // NukkitX
    public static final int DATA_AREA_EFFECT_CLOUD_RADIUS_PER_TICK = 96; // float - Backward Compatibility
    public static final int DATA_CHANGE_RATE = 96; // NukkitX
    public static final int DATA_AREA_EFFECT_CLOUD_RADIUS_CHANGE_ON_PICKUP = 97; // float - Backward Compatibility
    public static final int DATA_CHANGE_ON_PICKUP = 97; // NukkitX
    public static final int DATA_AREA_EFFECT_CLOUD_PICKUP_COUNT = 98; // int - Backward Compatibility
    public static final int DATA_PICKUP_COUNT = 98; // NukkitX
    public static final int DATA_INTERACTIVE_TAG = 99; // string (button text) - Backward Compatibility
    ...
    public static final int DATA_TRADE_XP = 102; // int - Backward Compatibility
    ...
    public static final int DATA_FLAG_RIDER_CAN_PICKUP = 60; // Backward Compatibility
    public static final int DATA_FLAG_RIDER_CAN_PICK = 60; // NukkitX
    public static final int DATA_FLAG_TRANSITION_SITTING = 61; // Backward Compatibility
    /**
     * @deprecated Typo from NukkitX
     */
    @Deprecated
    public static final int DATA_FLAG_TRANSITION_SETTING = 61; // NukkitX
    ...
    public static final int DATA_FLAG_DISABLED_BLOCKING = 72; // Backward Compatibility
    public static final int DATA_FLAG_TRANSITION_BLOCKING = 72; // NukkitX
